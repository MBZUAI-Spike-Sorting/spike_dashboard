...
const CorrelogramWidget = ({
  ...
  const clusterIds = useMemo(() => selectedClusters.slice(0, 4), [selectedClusters]);
  ...
  return (
    <div className="cluster-diagnostic-widget">
      ...
      <div className="diagnostic-content">
        {clusterIds.length === 0 ? (
          <div className="diagnostic-empty">Select up to four clusters to inspect auto- and cross-correlograms.</div>
        ) : error ? (
